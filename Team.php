...
<html lang="de">
    ...
    <head>
        ...
        <link rel="canonical" href="https://statuno.com/Team.php">
        ...
        <header class="header-area header-sticky wow slideInDown" data-wow-duration="0.75s" data-wow-delay="0s">
                ...
                <nav class="main-nav">
                  ...
                  <ul class="nav">
                    ...
                    <li class="scroll-to-section"><a href="Preise.php">Preise </a></li> 
                     ...
                     <li class="scroll-to-section"><a href="en/Team.php"><strong> EN </strong> </a></li> 
          ...
          <div class="teachers-section">
              <div class="service-item">
                ...
                <div class="content">
                <h4> Dipl.Ing. Thomas Zwanowetz . <a href="thomas_cv.php" class="cv-icon"
