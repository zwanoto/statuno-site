...
<head>
  ...
  <meta name="description" content="Contact form for statistical consulting and statistics tutoring">
  <meta name="author" content="">
  <link rel="preconnect" href="https://fonts.gstatic.com">
  <link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400;600;700;800&display=swap" rel="stylesheet">

  <title>Statistical Consulting - Contact</title>
  ...
  <link rel="canonical" href="https://statuno.com/en/Contact.php">
          ...
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li class="scroll-to-section"><a href="Prices.php">Prices </a></li> 
               ...
               <li class="scroll-to-section"><a href="../Kontakt.php"><strong> DE </strong> </a></li> 
...
<body>
    ...
    <div class="row">
      <div class="col-lg-8" style="background-color: lightblue; padding: 10px;">
        <div class="section-heading text-center wow bounceIn" data-wow-duration="1s" data-wow-delay="0.2s">
          <br><br>
          <h2 style="margin-top:50px"><strong><span class="contact-icon">✉️</span> Contact Form</strong></h2>
        </div>
 ...
 style="margin:40px">
            ...
            <button style='margin-top:20px' type="submit" class="btn btn-primary">Send Message</button>
          </form>
        </div>
      </div>
      <div class="col-lg-3 d-flex flex-column align-items-center justify-content-center" style="background-color: lightblue; padding: 20px;">
        <a href="https://wa.me/4368110869543?text=Hello%20I%20am%20interested%20in%20your%20services" target="_blank">
          <img src="../assets/images/Digital_Glyph_Dark_Green.svg" style="height: 80px;" alt='WhatsApp Logo' />
        </a>
        <a style="margin-top:10px" target="_blank" href="https://wa.me/4368110869543?text=Hello%20I%20am%20interested%20in%20your%20services">
          <p class="text-center" style="color:black">Message us on WhatsApp <br>+43 681 10869543</p>
        </a>
        <a href="Booking.php"><span class="big-calendar-icon">📅</span></a>
        <a href="Booking.php">
...
<script>
  function switchLanguage() {
      ...
      if (selectedLanguage === "de") {
          ...
          window.location.href = "https://www.statuno.com/Team.php";
      } else if (selectedLanguage === "en") {
          // Redirect to the English version of the website
          window.location.href = "https://www.statuno.com/en/Team.php";
      }
  }
  </script>
